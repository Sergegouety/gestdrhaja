...
if($total_taches == 0){$total_tach = 1;}else{ $total_tach = $total_taches;}
...
<section class="wrapper">
  <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="row">
                ...
                <div class="white-panel pn donut-chart">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-xs-6">
                      <h2>{{round(($total_tache_realises /$total_tach)*100,2)}}%</h2>
                    </div>
                  </div>
                </div>
                <!-- /grey-panel -->
              ...
              <div class="col-md-8 col-sm-8 mb">
                <div class="white-panel pn donut-chart">
                  ...
                  <h4 style="text-align: left; margin: 5px;">Nombre de taches totale : {{$total_taches}}</h4><br>
                  <h4 style="text-align: left; margin: 5px;">Nombre de tâches réalisées : {{$total_tache_realises}}</h4><br>
                  <h4 style="text-align: left; margin: 5px;">Nombre de tâches partiellement réalisées : {{$total_tache_patrealises}}</h4><br>
                  <h4 style="text-align: left; margin: 5px;">Nombre de tâches non réalisées : {{$total_tache_nonrealises}}</h4>
            ...
            <div class="form-panel">
              <h4 class="mb"> Activité Détails</h4>
               @if (session('success'))
            ...
            <div class="row">
                <div class="modal-body ace-scrollbar">
                 ...
                 @endif:
                  ...
                  <div class="col-sm-10" style="padding-top: 10px;">
                    <textarea class="form-control" rows="3" name="intitule" readonly >{{getInstanceName('activite','id',$ptab->id,'intitule')}}</textarea>
                  </div>
