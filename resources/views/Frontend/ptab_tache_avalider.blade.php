  ...
  <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="form-panel">
              <h4 class="mb">Statistique activité</h4>
            ...
            <div class="row">
                ...
                <div class="white-panel pn donut-chart">
                  <div class="white-header">
                    <h5>TACHES A VALIDER</h5>
                  </div>
                  <canvas id="serverstatus01" height="120" width="120"></canvas>
                  <script>
                    var doughnutData = [{
                        value: {{$total_taches - $total_tache_realises}},
                        color: "#FF6B6B"
                      },
                      {
                        value: {{$total_tache_realises}},
                        color: "#fdfdfd"
                      }
                    ];
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-xs-6">
                      @php if($total_taches == 0){$total_ = 1;}else{$total_ = $total_taches;} @endphp
                      <h2>{{round(($total_tache_realises / $total_)*100,2)}}%</h2>
                    </div>
                  </div>
                </div>
                <!-- /grey-panel -->
              ...
              <div class="col-md-8 col-sm-8 mb">
                <div class="white-panel pn donut-chart">
                  ...
                  <h4 style="text-align: left; margin: 5px;">Nombre de tâches totale : {{$total_taches}}</h4><br>
                   <h4 style="text-align: left; margin: 5px;">Nombre de tâches réalisées à valider : {{$total_tache_realises}}</h4><br>
                  <h4 style="text-align: left; margin: 5px;">Nombre de tâches partiellement réalisées à valider : {{$total_tache_patrealises}}</h4><br>
                  <h4 style="text-align: left; margin: 5px;">Nombre de tâches non réalisées à valider : {{$total_tache_nonrealises}}</h4>
              ...
              <section id="no-more-tables">
                <table class="table table-bordered table-striped table-condensed cf">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a onclick="actiondedetail('action',{{$action->id}})" href="#">Valider les activités</a></li>
                    ...
                    <li><a onclick="actiondedetail('activite',{{$action->id}})" href="#">Valider les taches</a></li>
