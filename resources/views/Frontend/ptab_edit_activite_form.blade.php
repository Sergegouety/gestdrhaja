  ...
  <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="form-panel">
              <h4 class="mb">Modifier Activitée</h4>
               @if (session('success'))
            ...
            <div class="row">
                ...
                <div class="modal-body ace-scrollbar">
                 <form class="form-horizontal m-t-10 p-20 p-b-0" method="post" action="{{ route('update.ptab.detail') }}" id="form_action">
                   ...
                   <input type="hidden" name="type_action" value="{{@$master_actions->id}}">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10" style="padding-top: 10px;">
                     <select class="form-control" name="master_activite_id" id="master_activite_id" onchange="getActiviteIntituleIndicateur(this.value)">
                      <option></option>
                      @foreach($master_activites as $activite)
                          <option value="{{@$activite->id}}" <?php if(@$activite->id == $ptab->reference_matrice){ echo 'selected';} ?> >{{ @$activite->ref.' : '.@$activite->intitule_activite}}</option>
                         @endforeach
                         <option value="new">Autre activité</option>
                    </select>
                    </div>
