...
if($total_activites == 0){$total_act = 1;}else{ $total_act = $total_activites;}
            ...
            <div class="row">
                ...
                <div class="white-panel pn donut-chart">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6 col-xs-6">
                      ...
                      <h2>{{round(($total_activite_realises /$total_act)*100,2)}}%</h2>
                    </div>
                  </div>
                </div>
                <!-- /grey-panel -->
              ...
              <div class="col-md-8 col-sm-8 mb">
                <div class="white-panel pn donut-chart">
                  ...
                  <h4 style="text-align: left; margin: 5px;">Nombre d'activité totale : {{$total_activites}}</h4><br>
                  <h4 style="text-align: left; margin: 5px;">Nombre d'activité réalisées : {{$total_activite_realises}}</h4><br>
                  <h4 style="text-align: left; margin: 5px;">Nombre d'activité partiellement réalisées : {{$total_activite_patrealises}}</h4><br>
                  <h4 style="text-align: left; margin: 5px;">Nombre d'activité non réalisées : {{$total_activite_nonrealises}}</h4>
